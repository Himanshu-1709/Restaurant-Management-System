...
<!-- Mirrored from fooddesk.dexignlab.com/codeigniter/demo/orders by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 17 Nov 2023 08:11:17 GMT -->
<!-- Added by HTTrack -->
...
<head>
    ...
    <link href="{{asset('user/assets/vendor/bootstrap-datetimepicker/css/bootstrap-datetimepicker.min.css')}}"
        rel="stylesheet" type="text/css" />

    <link href="{{asset('user/assets/vendor/bootstrap-select/dist/css/bootstrap-select.min.css')}}" rel="stylesheet"
        type="text/css" />

    <link href="{{asset('user/assets/vendor/jquery-nice-select/css/nice-select.css')}}" rel="stylesheet"
        type="text/css" />
